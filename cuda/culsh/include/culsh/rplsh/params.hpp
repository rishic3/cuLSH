...
struct RPLSHParams {
    /*
     * The number of hash tables. This parameter corresponds to an OR-amplification of
    ...
    /*
     * The number of random projections per hash table. This parameter corresponds to an
    ...
    /*
     * Optional seed used to generate random projections.
     */
    uint64_t seed;
};
